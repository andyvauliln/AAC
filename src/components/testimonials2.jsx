...
const TestimonialsMobile = () => {
  return (
    ...
    <div className="flex md:hidden z-20 w-full flex-col items-center justify-center bg-black p-8 ">
      <div className="text-center from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-4xl font-extrabold">Our Works</div>
      <div  className="p-4 ">
      ...
      <div className="text-center py-4 from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-4xl font-extrabold">Our Services</div>
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">Consultation Services</div>
        <div className="text-zinc-400">
      ...
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">Automation Solutions</div>
        <div className="text-zinc-400">
          ...
          <div><strong className='text-white'>Custom Workflow Automation:</strong> Tailored solutions to automate your specific business processes, increasing efficiency and productivity.</div>
        </div>
      </div>
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">Data Management</div>
        <div className="text-zinc-400">
      ...
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">Knowledge and Content Services</div>
        <div className="text-zinc-400">
          ...
          <div><strong className='text-white'>AI Summarization:</strong> Get quick, accurate summaries of large documents or datasets, ideal for research, reporting, and analysis.</div>
        </div>
      </div>
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">AI Development</div>
        <div className="text-zinc-400">
          <div><strong className='text-white'>AI Agents Development:</strong> Create intelligent agents for various applications, from customer service bots to advanced analytical tools.</div>
      ...
      <div  className="p-4">
        <div className="from-purple-600 via-pink-600 to-blue-600 bg-gradient-to-r background-animate bg-clip-text text-transparent text-xl font-extrabold">AI Development</div>
        <div className="text-zinc-400">
          <div><strong className='text-white'>Custom AI Models:</strong> Custom Large Language Models (LLM).</div>
      ...
      <div  className="p-4">
        ...
        <div className="text-zinc-400">
          <div><strong className='text-white'>Text-to-Image:</strong> Turn text descriptions into images, great for creative industries, advertising, and media.</div>
          <div><strong className='text-white'>Text-to-Voice:</strong> Convert text into natural speech for accessibility, content creation, or customer service.</div>
          <div><strong className='text-white'>Voice-to-Text:</strong> Accurate speech-to-text services for transcription, documentation, and more.</div>
          <div><strong className='text-white'>Image-to-Text:</strong> Extract and interpret text from images for data entry, archiving, and analysis.</div>
          <div><strong className='text-white'>Text-to-Text:</strong> Sophisticated text modification, including translation, paraphrasing, and summarization.</div>
          <div><strong className='text-white'>Text-to-Video:</strong> Create engaging video content directly from text inputs, ideal for social media, marketing, and educational content.</div>
        </div>
      </div>
    </div>
  );
